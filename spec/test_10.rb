...
# All units can attack and receive take_damage, so that logic should actually be on the Unit class, not the Peasant class
# This way, you don't have to add take_damage and attack methods on all types of units
...
describe Unit do
  ...
  describe "#attack!" do
    it "should deal the appropriate (attack power based) take_damage to the enemy unit" do
      enemy_unit = Unit.new(40, 5)
      expect(enemy_unit).to receive(:take_damage).with(3)
